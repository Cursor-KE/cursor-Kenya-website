...
| `ALLOW_SUPER_USER_EMAIL_AUTO_APPROVAL` | Optional | Set to `true` only for an intentional production bootstrap of the hardcoded super-user email. In production, the address otherwise signs up as a pending admin. |
