...
| `LUMA_WEBHOOK_SECRET` | Recommended for Luma webhooks | Verifies Luma webhook signatures from the `Webhook-Signature: t=...,v1=...` header using the returned `whsec_...` secret. |
